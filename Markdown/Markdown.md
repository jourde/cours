...
2. Vous formatez votre texte sans quitter votre clavier et sans avoir à plonger dans un sous-menu pour obtenir l’effet désiré (vous pouvez aussi le faire certains champs d'écriture dépourvus de boutons de mise en forme, comme dans des commentaires de billets de blogues). 
